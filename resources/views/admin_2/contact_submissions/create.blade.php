...
<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold text-gray-800">Add Contact & Social Media</h1>
        <p class="text-gray-500 text-sm mt-1">Add a new contact and social media information.</p>
    </div>
...
<div class="bg-gray-100 rounded-xl shadow-sm border border-gray-200 p-6 max-w-3xl">
    <form action="{{ route('admin_2.contact_submissions.store') }}" method="POST">
        ...
        <h3 class="text-lg font-medium text-gray-800 border-b border-gray-200 pb-2 mb-4 mt-8">Social Media Links</h3>
        ...
        <div class="flex justify-end gap-3 pt-4 border-t border-gray-200 mt-8">

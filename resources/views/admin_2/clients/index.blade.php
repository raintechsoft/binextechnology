...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <p class="text-gray-500 text-sm mt-1">Manage the clients displayed on your website.</p>
    </div>
        ...
        <table class="w-full text-left text-sm whitespace-nowrap">
            ...
            <tbody class="divide-y divide-gray-100 text-gray-700">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-6 py-4">
                        @if($client->logo)
                            <img src="{{ Storage::url($client->logo) }}" alt="{{ $client->name }}" class="h-10 w-auto object-contain bg-gray-100 rounded border border-gray-200 p-1">
                        @else
                            <div class="h-10 w-10 bg-gray-100 rounded border border-gray-200 flex items-center justify-center text-gray-500">
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="flex justify-end gap-2">
                            <a href="{{ route('admin_2.clients.edit', $client) }}" class="text-blue-600 hover:text-blue-800 p-2 border border-blue-200 hover:bg-blue-50 bg-white rounded transition-colors" title="Edit">

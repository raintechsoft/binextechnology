...
<div class="mb-6 flex items-center justify-between">
    <div>
        ...
        <p class="text-gray-500 text-sm mt-1">Create a new service offering for your website.</p>
    </div>
    ...
    <form action="{{ route('admin_2.services.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-5">
            ...
            <textarea id="short_description" name="short_description" rows="2" required
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 transition-colors">{{ old('short_description') }}</textarea>

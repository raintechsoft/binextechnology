...
<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold text-gray-100">Add New Service</h1>
        <p class="text-gray-400 text-sm mt-1">Create a new service offering for your website.</p>
    </div>
...
<div class="bg-gray-800 rounded-xl shadow-sm border border-gray-700 p-6 max-w-3xl">
    <form action="{{ route('admin_2.services.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-5">
            ...
            <textarea id="short_description" name="short_description" rows="2" required
                class="w-full px-4 py-2 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-white transition-colors">{{ old('short_description') }}</textarea>

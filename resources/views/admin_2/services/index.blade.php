        ...
        <table class="w-full text-left text-sm whitespace-nowrap">
            ...
            <tbody class="divide-y divide-gray-100 text-gray-700">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4">
                        @if($service->image)
                            <img src="{{ asset('storage/' . $service->image) }}" alt="{{ $service->title }}" class="h-10 w-10 object-cover rounded shadow-sm border border-gray-200 bg-gray-50">
                        @else
                            <div class="h-10 w-10 flex items-center justify-center bg-gray-50 border border-gray-200 rounded text-gray-500">
                ...
                <tr>
                    <td colspan="5" class="px-6 py-8 text-center text-gray-500">
                        <div class="flex flex-col items-center">
                            <i class="fas fa-inbox text-4xl mb-3 text-gray-600"></i>

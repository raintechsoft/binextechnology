...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-100">Services</h1>
        <p class="text-gray-400 text-sm mt-1">Manage the services displayed on your website.</p>
    </div>
        ...
        <table class="w-full text-left text-sm whitespace-nowrap">
            ...
            <tbody class="divide-y divide-gray-100 text-gray-200">
                ...
                <tr class="hover:bg-gray-900 transition-colors">
                    ...
                    <td class="px-6 py-4 text-gray-300 max-w-md whitespace-normal">
                    ...
                    <td class="px-6 py-4">
                        @if($service->image)
                            <img src="{{ asset('storage/' . $service->image) }}" alt="{{ $service->title }}" class="h-10 w-10 object-cover rounded shadow-sm border border-gray-700 bg-gray-800">
                        @else
                            <div class="h-10 w-10 flex items-center justify-center bg-gray-900 border border-gray-700 rounded text-gray-400">
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="flex justify-end gap-2">
                            <a href="{{ route('admin_2.services.edit', $service) }}" class="text-blue-600 hover:text-blue-800 p-2 border border-blue-200 hover:bg-blue-50 bg-gray-800 rounded transition-colors" title="Edit">
